...
const BuildMeal = () => {
	...
	return (
		<div className="p-6 space-y-4">
			...
			<div>
				<strong>What’s a Dish?</strong><br />
				A <strong>dish</strong> is a collection of ingredients you cook or prep together — like chicken and rice, pasta with sauce, or a veggie bowl.
				Grouping ingredients helps you portion and plan accurately.
			</div>
			</div>
			...
			<Button onClick={() => setAddFoodOpen(true)}>Add Ingredient</Button>
