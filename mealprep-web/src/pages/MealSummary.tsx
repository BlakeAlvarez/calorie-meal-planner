...
export default function MealSummaryPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 print:p-4 print:bg-white print:text-black space-y-8">
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">📊 Per-Person Breakdown</h2>
          ...
          <tbody>
            {peopleWithActuals.map((p) => (
              <tr key={p.id} className="border-b">
                ...
                <td className="p-2">{formatKcal(p.actualKcalPerMeal)}</td>
                <td className="p-2">{formatKcal(p.actualTotalCalories)}</td>
              </tr>
            ))}
          </tbody>
        </table>
